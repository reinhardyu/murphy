...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <!-- 正常 -->
      <span class="logo-lg"><b>Murphy</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <c:if test="${user.headImage != null and user.headImage != ''}">
            <img src="${user.headImage}" class="img-circle" alt="User Image">
          </c:if>
          <c:if test="${user.headImage == null or user.headImage == ''}">
            <img src="/AdminLTE/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
          </c:if>
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            <li><a _href="/AdminLTE/index.html" onclick="Hui_admin_tab(this)"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li class="active"><a _href="/AdminLTE/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    <div id="iframe_box" class="Hui-article">
      <div class="show_iframe">
        ...
        <iframe scrolling="yes" frameborder="0" src="/jsp/base/mailbox.jsp"></iframe>
      </div>
    </div>
  </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 Murphy.</strong> All rights
    reserved.
  </footer>
